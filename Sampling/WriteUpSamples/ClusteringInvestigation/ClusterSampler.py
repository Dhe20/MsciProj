...
for i in range(0,len(investigated_values)):
    Investigation = Sampler(universe_count = 500-124, p_det=True, gamma = False, event_distribution='Proportional', total_luminosity=total_luminosity,
                            characteristic_luminosity=characteristic_luminosity, resolution_H_0 = resolution_H_0, H_0_Min = H_0_Min, H_0_Max = H_0_Min,
                            ...
                            investigated_characteristic = investigated_characteristic, investigated_value = investigated_values[i], save_normally=False, start_seed = 124)
