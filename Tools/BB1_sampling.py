...
ax.plot(x,y,ls='dashed',lw=4, c='r', label='Theoretical BB1')
ax.plot(x_l,y_l,ls='dashed',lw=4, c='b', label=r'Faint end $\sim L^{\beta+1}$')
ax.plot(x_m,y_m,ls='dashed',lw=4, c='magenta', label=r'Middle range $\sim L^{\beta}$')
